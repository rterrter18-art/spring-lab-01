...
public class NotificationService {
    ...
    private final Notifier console;              // @Qualifier("console")
    private final List<Notifier> all;            // барлық имплементациялар, @Order бойынша реттелген
    private final Map<String, Notifier> byName;  // Bean name арқылы
